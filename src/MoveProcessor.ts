...
module MoveProcessor {
    export function ExecuteTurn (state: State, pgn: string, turn: StandardTurns, gameType: GameTypes, hideOutput: boolean, debug?: boolean): MoveResult {
     ...
     */
    export function updateBoardByCord (board: string[][], moveCord: Move, enPassant: boolean, turn: StandardTurns, debug: boolean, hideOutput: boolean) {
        let newBoard = board
